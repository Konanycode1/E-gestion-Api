...
Router.get(
  "/getCategorieByRef/:reference",
  Auth,
  CategorieController.indexByRef
); // On définit la route get permettant de récupérer un seul categorie via son idenfitiant unique
...
Router.post("/boutique/", Multer, Boutique.create);
